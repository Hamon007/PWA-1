...
Das war, in seiner Kürze, das Beste was jemand an diesem Abend gesagt hatte.`,
 ...
 next: "a5k2_sera_varkos",
 alignEffect: { chaos: 5, verborgenheit: 1 },
...
»Nein.« Sie schaute auf den Countdown über ihrem Kopf. Kaito sah ihn. Sie wusste, dass er ihn sah. »Kannst du es wirklich?«
...
»Veyras Paket. Die Botschaft in der dritten Schicht des Kuchens.« Ein kleines Lächeln. »Ich bin Prinzessin. Ich habe Zeit gehabt das zu lernen.«
...
Herzogin Valentine, kalt: »...Kross wird das nicht akzeptieren.«`,
 ...
 next: "a5k7_kross",
 alignEffect: { schatten: 2, chaos: 2, verborgenheit: 1 },
...
»...Dreißig. Es waren dreißig. Und ich habe JEDEN getötet. Mit einem BEFEHL.«`,
 ...
 next: "a5k7_roland_fluch", affinityEffect: { roland: 20 },
 ...
 next: "a5k8_prophet", affinityEffect: { roland: 15 }, alignEffect: { schatten: 2, ordnung: 1 },
 ...
 a5k7_roland_fluch: {
 act: "AKT V", chapter: "Kapitel 37 — Curse.Break()", title: "Level 34",
 scene: "Kreuzweg, nach dem Kampf — Nacht",
 bg: "night", music: "theme_family",
 text: `Kross kniete vor Roland.

Das war das Merkwürdigste was ich je gesehen hatte — General Kross, die Eiserne Faust, vor einem Mann kniend der sein ganzes Leben lang Level 34 gewesen war.

»Ich habe den Befehl gegeben«, sagte Kross. »Den Fluch. Vor zwanzig Jahren.« Er schaute auf den Boden. »Du warst ein Soldat der zu viel gesehen hatte und zu wenig schwieg. Das war mein Fehler. Nicht deiner.«

Roland schwieg.

»Ich kann es rückgängig machen. Wenn du willst.«

Stille. Lang.

Roland schaute auf seine Hände. Die Hände die jeden Morgen das Schwert geschwungen hatten. Zwanzig Jahre, Level 34, während alle anderen um ihn herum weiterwuchsen.

»Ja«, sagte er schließlich. »Ich will.«

Kross legte seine Hand auf Rolands Schulter. Ein kurzes Leuchten — System-Code der aufgelöst wird, eine Kette die fällt. Nicht dramatisch. Nur: weg.
...
Das war alles. Aber es war das erste Mal seit zwanzig Jahren dass Roland dieses Wort benutzt hatte.

Das Terminal: \`ROLAND ASHFORD — FLUCH: AUFGEHOBEN. PROGRESSION: AKTIV. AKTUELLES LEVEL: 34. POTENTIAL: UNBEGRENZT.\`

Ich zeigte ihm das. Er las es. Nickte einmal.

»Dann fange ich morgen wieder an.«`,
 choices: [{ text: "→ Der Void-Prophet", next: "a5k8_prophet" }],
...
»Doch. Du hast 500 Jahre gelitten, und du willst, dass es AUFHÖRT. Aber nicht so.«`,
 ...
 next: "a5k9_convergence", alignEffect: { schatten: 1, ordnung: 1 }, flagEffect: { prophetErgebnis: "wildcard" },
 ...
 next: "a5k8_prophet_kampf", alignEffect: { schatten: 3, chaos: 4 }, flagEffect: { prophetErgebnis: "besiegt_befreit" },
 ...
 a5k8_prophet_kampf: {
 act: "AKT V", chapter: "Kapitel 38 — Prophet.Fight()", title: "500 Jahre",
 scene: "Die Ruinen — halb real, halb Void",
 bg: "void", music: "theme_void_terminal",
 text: `Er griff nicht an.

Das war das Erste was ich verstand.

Martin Ashvale — was von ihm übrig war nach 500 Jahren Void-Exposition — griff nicht *mich* an. Er griff das System an. Immer. Jede Bewegung, jede Void-Entladung, jede flackernde Manifestation seines Körpers zwischen Fleisch und Code: ein Angriff auf das Konstrukt das ihn so gemacht hatte.

Ich stand im Weg.

Das war das Problem.

Er sah mich nicht. Er sah das System. Und das System war überall — auch in mir, auch um mich, auch in der Luft zwischen uns.

»Martin.«

Keine Reaktion. Die dreifache Stimme, dissonant, Schichten über Schichten.

»MARTIN ASHVALE.«

Ein Flackern. Kurz. Das Gesicht des Bibliothekars — jung, verblüfft, 500 Jahre alt und für einen Moment wieder zwanzig — schaute durch den Void-Körper.

Das war mein Fenster.

[Code.Modify] auf seine Void-Verbindung. Nicht brechen — *stabilisieren*. Den Code der ihn auseinanderhielt, ihn zusammenzuhalten versuchen. Es war wie versuchen, Wasser mit den Händen aufzuhalten.

Er schrie. Nicht aus Schmerz — aus Erleichterung. Als hätte jemand zum ersten Mal in 500 Jahren den Schmerz unterbrochen.

Drei Minuten. Ich hielt es drei Minuten.

Dann: ein junger Mann auf dem Boden. Erschöpft. Real.

Ich kniete neben ihm. Mein linker Arm zitterte. Das Terminal: \`[Code.Modify] ÜBERLASTET. ERHOLUNGSZEIT: 72 STUNDEN.\`
...
»Nein«, sagte ich ehrlich. »Aber du bist hier.«

Das reichte ihm. Er schloss die Augen wieder. Schlief — richtig schlief, zum ersten Mal seit Jahrhunderten.`,
 choices: [{ text: "→ Konvergenz", next: "a5k9_convergence" }],
 },
...
Das war, dachte er, das Seltenste was ihm je passiert war.`,
 ...
 a5k10_nacht_sera: {
 act: "AKT V", chapter: "Kapitel 40 — Die letzte Nacht", title: "Sera",
 scene: "Der Felsen — Fluss, Millheim",
 bg: "night", music: "theme_family",
 text: `Der Felsen war noch da.

Natürlich war er noch da. Steine gehen nicht weg. Aber er sah kleiner aus als ich ihn in Erinnerung hatte — oder ich war größer geworden, was dasselbe bedeutete.

Sera saß bereits dort als ich ankam. Das überraschte mich nicht.

Kein Wort zuerst. Das war Seras Art. Sie saß und schaute auf das Wasser und ließ die Stille arbeiten bis sie fertig war.

Dann warf sie einen Stein.

Er landete weit — weiter als ich es je schaffen würde.

»Immer noch besser als du.«

»Ja.«

Ich setzte mich neben sie. Das Wasser bewegte sich. Irgendwo rief ein Vogel.

»Kaito.«

»Ja.«

»Wenn das morgen schiefgeht—«

»Es geht nicht schief.«

»Wenn es schiefgeht«, sagte sie, ohne Unterbrechung, »Dann will ich dass du weißt: dieser Fels. Diese Nacht. Das war genug.«

Ich verstand nicht sofort was sie meinte.

Dann doch.

Sie meinte: Du bist genug. Das hier ist genug. Selbst wenn morgen alles endet.

Ich warf einen Stein. Er landete deutlich kürzer als ihrer.

»Du wirst es noch lernen«, sagte Sera.

»Nein, werde ich nicht.«

Sie lachte — echt, kurz, das Lachen das sie nur hatte wenn sie dachte, niemand achtete drauf.

Wir blieben bis die Sterne wanderten.`,
 choices: [{ text: "→ Aufbruch", next: "a5k10_aufbruch" }],
 },

 a5k10_nacht_yuki: {
 act: "AKT V", chapter: "Kapitel 40 — Die letzte Nacht", title: "Yuki",
 scene: "Verbotener Turm — Dach",
 bg: "night", music: "theme_elena_song",
 text: `Kein Countdown mehr.

Das war das Erste was auffiel wenn man neben Yuki stand — die Abwesenheit. Drei Jahre hatte dieser Timer über ihr geschwebt wie eine Klinge. Jetzt: Luft. Freier Himmel.

Sie merkte, dass ich auf die Stelle schaute wo er gewesen war.

»Komisch«, sagte sie. »Ich vermisse ihn fast. Den Countdown.«

»Wirklich?«

»Er hat mir gesagt wie viel Zeit ich habe. Jetzt weiß ich es nicht mehr.« Sie schaute auf die Sterne. »Genauso wie alle anderen.«

Ich gab ihr den Hasen-Anhänger zurück.

Sie nahm ihn. Schaute ihn an. Dann legte sie ihn in meine Hand zurück.

»Behalt ihn noch einen Tag.«

»Bis morgen?«

»Bis morgen.«

Wir saßen auf dem Dach und die Nacht war warm auf eine Art die nicht zum Herbst passte. Yuki hatte die Knie an die Brust gezogen wie eine Person die sehr klein sein möchte um zu sehen ob die Welt sie trotzdem findet.

Die Welt fand sie.

Ich glaube, die Welt findet Yuki immer.

»Danke«, sagte sie irgendwann. Ohne Präzisierung. Ohne Kontext.

Ich wusste trotzdem wofür.
...
»Gern.«`,
 ...
 a5k10_nacht_familie: {
 act: "AKT V", chapter: "Kapitel 40 — Die letzte Nacht", title: "Familie",
 scene: "Lager der Verbündeten",
 bg: "night", music: "theme_family",
 text: `Elena sang.

Nicht für jemanden — für die Nacht. Für das Feuer. Für das Gewohnheit, die sich über zwanzig Jahre in ihr festgesetzt hatte wie Wurzeln in Stein.

Ich saß zwischen ihr und Roland.

Nicht wie ein Anführer. Nicht wie ein Held der morgen das System umschreibt.

Wie ein Kind zwischen seinen Eltern.

Das war, merkte ich, was ich gebraucht hatte.

Roland sagte kein Wort. Er war der Typ der keine Worte brauchte wenn er meinte was er meinte. Er legte einmal kurz seine Hand auf meine Schulter — einmal, zwei Sekunden, dann zurück.

Das war, bei Roland, eine Rede.

Elena hörte auf zu singen. Schaute auf mich. Legte ihre Hand auf meine Wange wie damals, als ich als Baby nicht schlafen konnte.

»Du hast Gregors Augen«, sagte sie. »Nicht beim Aussehen. Beim Schauen.«

Mira schlief bereits mit dem Kopf auf Rex' Flanke.

Ich schaute meine Familie an.

Gregor war nicht mehr da. Aber er war irgendwie da — in dem was wir miteinander redeten und nicht redeten, in den Geschichten die Elena manchmal erzählte, in dem Tagebuch das in meiner Tasche lag.

Manche Menschen hören nicht auf anwesend zu sein, nur weil sie sterben.`,
 choices: [{ text: "→ Aufbruch", next: "a5k10_aufbruch" }],
 },

 a5k10_nacht_nullen: {
 act: "AKT V", chapter: "Kapitel 40 — Die letzte Nacht", title: "Die Nullen",
 scene: "Verbotener Turm — Keller, Gorricks Schmiede",
 bg: "night", music: "theme_family",
 text: `Gorrick erzählte die Geschichte wie er zum ersten Mal eine Rune falsch geschrieben hatte.

Dreißig Jahre seiner Arbeit. Seiner besten Arbeit. Eine einzige falsche Rune und das Schwert hatte beim ersten Testschlag eine Wand eingerissen und Gorrick quer durch die Schmiede geworfen.

Er erzählte es mit der Freude eines Mannes der gelernt hat, Katastrophen als Anekdoten zu behandeln.

Alle lachten.

Rex pustete kurz blaues Feuer — nicht absichtlich, einfach weil er lachte und Drachen bei Lachen manchmal Feuer pusten.

Ren saß fester als ich ihn je gesehen hatte. Fast vollständig real. Er lachte nicht laut — er hatte noch nicht gelernt wie man laut lacht — aber er lächelte mit dem Gesicht von jemandem der Lachen zum ersten Mal als körperliche Empfindung erlebt.

Veyra hatte aufgehört, ihr Gesicht zu kontrollieren.

Das war das Seltenste. Veyra ohne Maske war jemand der sich überraschend oft für kleine Dinge freute — eine gute Formulierung, ein unerwartetes Argument, Gorricks Timing beim Erzählen.

Aria summte das Lied.

Ich saß dort und dachte: Das hier ist was ich schütze.

Nicht das System. Nicht die Welt.
...
Das hier.`,
 ...
 a5k10_nacht_allein: {
 act: "AKT V", chapter: "Kapitel 40 — Die letzte Nacht", title: "Allein",
 scene: "Verbotener Turm — Dach",
 bg: "void", music: "theme_void_terminal",
 text: `Das Dach.

Stille. Zwei Monde. Ein Terminal.

Ich öffnete Gregors Tagebuch. Seite 47. Die letzte Mal. Ich hatte sie so oft gelesen, dass ich sie ohne Licht lesen konnte.

*Die Siebte wartet auf denjenigen der lesen kann, was kein System lesen kann.*

Ich hatte das gelesen und gewartet dass es sich wie eine Erfüllung anfühlte.

Es fühlte sich an wie ein Satz in einem Buch.

Das war in Ordnung. Manche Dinge bedeuten mehr als sie fühlen.

Das Terminal öffnete sich. Ich hatte es nicht geöffnet.
...
Dann schloss ich das Terminal, das Tagebuch, und schaute auf die Monde bis die Nacht heller wurde.`,
 choices: [{ text: "→ Aufbruch", next: "a5k10_aufbruch" }],
 },
...
»Septima. Wenn du mich hören kannst... ich bin bereit.«`,
 ...
 choices: [{ text: "→ AKT VI: System.Exit() — Das Endgame", next: "a6k1_teaser" }],
 },
