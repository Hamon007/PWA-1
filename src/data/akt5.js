...
export const AKT_V = {
  ...
  a5k1_kriegsplan: {
    ...
    textConditional: {
      militaerisch: `Akiras öffentliche Verweigerung war bereits geschehen bevor Veyras Bericht ankam. »Die Helden verweigern den Einsatz«, stand in der Meldung. »Mordecai hat keine Speerspitze mehr.« Ich las es und sagte nichts. Manchmal ist das Beste, das man tun kann, früh genug angefangen zu haben.`,
      diplomatisch: `Lilithia hatte Varkos' Mobilisierung verlangsamt — drei Wochen. Das hatte Mordecai die Grundlage für »wachsende Dämonenbedrohung« entzogen. Veyras Bericht sagte: »Operation Reinigung wackelt.« Ich sagte: »Dann stoßen wir jetzt.«`,
      alle: `Drei Fronten gleichzeitig. Veyra in Aetheria Prime. Kaito und Sera nach Drak'Moor. Ren zu den Helden. Das Terminal: »Kein Druck.« Ich: »Danke, Terminal.«`,
      default: ``,
    },
    scene: "Verbotener Turm — 1 Jahr, 4 Monate bis zum Update", bg: "night", music: "theme_mystery",
    conditionalFlag: "kriegsPrioritaet",
    textConditional: { militaerisch: `Akiras Verweigerung war bereits geschehen. Mordecai hatte keine Speerspitze mehr. Manchmal ist das Beste früh genug angefangen zu haben.`, diplomatisch: `Lilithia hatte Varkos drei Wochen gebremst. Mordecais Bedrohungsrhetorik stand ohne Fundament.`, alle: `Drei Fronten gleichzeitig. Das Terminal: »Kein Druck.« Ich: »Danke, Terminal.«`, default: `` },
...
Herzogin Valentine, kalt: »...Kross wird das nicht akzeptieren.«`,
    choices: [
      ...
      { text: "D) »Mordecai. Was Secunda Ihnen gesagt hat — hören Sie mir zu. Einmal.«",
        desc: "[SC] Nur wenn mordecaiRedemptionMoeglich=true. Der direkte Moment der Wahrheit.",
        ...
        narrativeFeedback: "Mordecai schaut ihn an. Der Erzbischof, der sein Leben dem System gewidmet hat. Er öffnet den Mund. Schließt ihn. Und setzt sich dann — ohne Würde, ohne Haltung — auf die Ratsbank. Wie ein Mann der nicht mehr kämpft weil er verstanden hat wogegen er gekämpft hat.",
      },
    ]
  },
...
Er griff nach dem Stift. Und begann zu SCHREIBEN.`,
  ...
  a5k10_abschied: {
    ...
    textConditional: {
      familie: `Aria summte. Ich hörte es erst nach einer Weile — weil es so selbstverständlich war, so vertraut. Das Lied. Elenas Lied. Das Lied das keiner kannte und das trotzdem immer da war. Aria summte es ohne Unterbrechung, ohne es zu wissen, während Rex' Feuer blau brannte. Ich starrte sie an. Sie bemerkte meinen Blick. »Was?« — »Woher kennst du diese Melodie?« — »Ich weiß nicht«, sagte sie. »Sie ist einfach... da. Schon immer.« Ich sagte nichts mehr. Aber ich wusste: Das Lied hatte einen Ursprung. Und der war älter als Aria.`,
      default: ``,
    },
    scene: "Verbotener Turm — Nacht vor dem Endgame", bg: "night", music: "theme_elena_song",
    conditionalFlag: "ariaZugang",
    textConditional: { familie: `Aria summte Elenas Lied — ohne es zu wissen. »Woher kennst du diese Melodie?« — »Sie ist einfach da. Schon immer.« Das Lied hatte einen Ursprung.`, default: `` },
