...
Seltsam, wie das funktionierte. Man musste sterben und in einer anderen Welt wiedergeboren werden, um zu lernen, wie Freundschaft sich anfühlte.`,
 ...
 textConditional: {
 true: `Gregor hatte mich beobachtet. Seit dem ersten Wort. Manchmal hielt er inne — nicht weil die Geschichte zu Ende war. Er prüfte, ob ich zuhörte. Nicht wie ein Kind. Wie jemand, der speichert.`,
 default: ``,
 },
 music: "theme_gregor",
...
Und er erzählte sie MIR. Nicht Mira, obwohl sie auf seinem Schoß saß. Mir. Weil er wusste — oder ahnte — dass ICH es verstehen würde.`,
 ...
 act: "AKT II", chapter: "Kapitel 5 — Compile.Childhood()", title: "Der siebte Stern",
 scene: "Gregors Haus — danach, allein",
 bg: "village", music: "theme_gregor",
 text: `Gregor stellte die Tasse sehr langsam ab.

Dann schwieg er. Lang. Nicht das Schweigen eines Mannes, der die Antwort sucht — das Schweigen eines Mannes, der entscheidet, wie viel er geben kann.

Mira war schon schlafen gegangen. Elena in der Küche. Roland draußen. Nur die zwei von uns.

Schließlich:

»Der siebte Stern.« Er sprach das Wort wie etwas, das er nicht oft benutzt hatte. »Du hast es genau gewusst, oder? Dass ich nicht von einem Stern rede.«

Ich wartete.

»Es gibt ein Wort in Alt-Aetherisch«, sagte Gregor, sehr leise. »Sehr alt. Vor der Systematisierung. Vor allem, was das System jetzt ist.«

Er schaute aus dem Fenster.

»*Septima.*«

Das Wort fiel in die Stille wie ein Stein in tiefes Wasser. Kein Aufprall. Nur das langsame Ausbreiten von Ringen.

»Ich weiß nicht, was es bedeutet«, sagte Gregor. »Ich habe es einmal gehört. Vor vielen Jahren. Von jemandem der sagte: 'Wenn die Zeit kommt, wird der richtige Mensch dieses Wort kennen.' «

Er schaute mich an.

»Kannte ich recht, dass du dieser Mensch bist?«

Ich dachte an das Terminal. An die Stimme, die manchmal in der Stille auftauchte. An eine Frau, die er nicht kannte und ich noch nicht ganz.

»Ja«, sagte ich.

Gregor nickte einmal. Langsam.

»Gut«, sagte er. »Dann weißt du, was du tun musst.«

Er stand auf. Schloss das Fenster.

»Sag deiner Mutter Gute Nacht.«`,
 choices: [{ text: "→ Rolands Training", next: "a2k2_rolands_training" }],
 },
...
Roland, überrascht: »Du bist zu klug für dein Alter, Junge.«`,
 ...
 conditionalFlag2: "rolandFluchWissen",
 textConditional2: {
 rache: `Ich hatte den Namen seit einem Jahr. Vex. Jetzt sah ich was Vex getan hatte — jeden Morgen, wenn Roland trainierte und das System es ignorierte. Jeder Schwung: ein Beweis. Jede Wiederholung: eine Anklage.`,
 beruehrung: `Ich erinnerte mich an seine Hand um meine. Das seltene Lächeln. Er hatte keine Ahnung was ich wusste, als er mich anlächelte. Das machte es nicht einfacher.`,
 verschwiegen: `Ein Jahr. Das Geheimnis hatte jetzt eine Form — saß in mir wie ein Stein, nicht schwer genug zum Bremsen, aber da. Immer da.`,
 default: ``,
 },
...
Aber in diesem Moment — dieser einen Stille — war das egal.`,
 ...
 act: "AKT II", chapter: "Kapitel 7 — Debug.Life()", title: "Affinität",
 scene: "Waldlichtung hinter Millheim",
 bg: "village", music: "theme_family",
 text: `Sera schaut auf ihre Hände.

Nicht das erste Mal — aber zum ersten Mal mit dem Wissen dass das was sie sah einen Namen hatte.
...
Sie atmete aus. Einmal, lang, mit dem Geräusch von jemandem der eine schwere Kiste absetzt.

»Aber ich bin kein Monster.«

»Nein.«

Sera schaute ihre Hände noch einen Moment an. Dann — langsam, bewusst — schloss sie sie zu Fäusten.

Nicht vor Wut. Vor Entschlossenheit.

»Ich will lernen es zu kontrollieren.«

Das war das Mutigste was ich an diesem Tag gehört hatte. Nicht Kampf, nicht Rebellion — einfach: Ich will das Ding das mich erschreckt, in etwas verwandeln das ich kenne.

»Gut«, sagte ich. »Dann fangen wir an.«`,
 choices: [{ text: "→ Das Training beginnt", next: "a2k3_sera_training" }],
 },

 a2k3_sera_luege: {
 act: "AKT II", chapter: "Kapitel 7 — Debug.Life()", title: "Ich weiß es nicht",
 scene: "Waldlichtung hinter Millheim",
 bg: "village", music: "theme_family",
 text: `Sera hörte auf mich.

Das war das Problem.

Sie schaute mich an — direkt, aufmerksam, mit den Augen von jemandem der gelernt hat, Gesichter zu lesen weil Gesichter ehrlicher waren als Worte — und sie nickte.
...
Ich wusste die Antwort. Ich hatte die Antwort im Code gesehen, klar und unbestreitbar. Halb Dämonin. Vater: Varkos, Kriegsherr von Drak'Moor.

Ich hatte ihr gesagt: Ich weiß es nicht.

Das Terminal zeigte nichts. Es kommentierte meine Lügen nicht.

Aber ich registrierte: das Gewicht davon.

Die Art wie Sera mir vertraute, weil ich sie darum gebeten hatte — war dieses Vertrauen ein Geschenk oder eine Waffe, je nachdem was ich damit machte?

Ich wusste die Antwort.

Trotzdem sagte ich: »Lass uns mit dem Training anfangen.«`,
 choices: [{ text: "→ Das Training beginnt", next: "a2k3_sera_training" }],
...
»...Natürlich kannst du das.«`,
 ...
 next: "a2k3_geschenk_buch_reaktion",
 ...
 a2k3_geschenk_buch_reaktion: {
 act: "AKT II", chapter: "Kapitel 7 — Debug.Life()", title: "Gregors Antwort",
 scene: "Gregors Haus",
 bg: "village", music: "theme_gregor",
 text: `Gregors Augen leuchteten auf.

Nicht aus Freude — aus Erkenntnis. Als hätte er auf genau diesen Satz gewartet, seit dem Moment, in dem er das Buch in die Hand genommen hatte.

Dann wurden seine Augen ernst.

»Dann sorge dafür«, sagte er ruhig, »Dass es das Richtige verändert.«

Ich schaute auf das Buch. Die erste Seite, die ich je gelesen hatte.

»Wie erkenne ich das Richtige?«

Gregor lächelte. Das echte Lächeln — nicht das Dienstags-Erzähler-Lächeln, sondern das Lächeln, das er nur hatte, wenn etwas ihn wirklich freute.

»Das«, sagte er, »Ist die beste Frage, die du je gestellt hast.«

Er stand auf, um Tee nachzufüllen.

»Die Antwort steht auf Seite 47. Aber lies sie nicht heute. Warte, bis du weißt, warum du sie brauchst. Dann wird sie etwas bedeuten.«

Er stellte die Tasse ab.

»Das ist der Unterschied zwischen lesen und *verstehen*.«`,
 choices: [{ text: "→ Aldwins Warnung", next: "a2k3_warnung" }],
 affinityEffect: { gregor: 5 },
 },
...
»Nicht spezifisch. Sie suchen nach einer 'System-Anomalie' in dieser Region. Die Systemkirche hat ihre Inquisitoren losgeschickt — eine Spezialeinheit unter General Kross.«
...
Elena erstarrte. In ihren Augen: Erkenntnis. Schmerz. Angst. Und — unter allem — Stolz.`,
 ...
 timedSeconds: 5,
 timedDefault: 1,
 text: `Finn stand neben mir. Holzschwert in beiden Händen — der Griff zu fest, die Knöchel weiß.

»Ich gehe nicht. Du bleibst, ich bleibe. Bester Freund. Für immer. Weißt du noch?«

Zwölf Kirchensoldaten. Ein Rang-B-Inquisitor.

Und Finn, dessen Hände zitterten und der trotzdem nicht zurückwich.
...
Was sagst du?`,
 ...
 a2k5_finn_bleibt: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "»Hinter mir.«",
 scene: "Dorfzentrum, Millheim",
 bg: "chaos", music: "theme_family",
 text: `Finn blieb.

Er blieb hinter mir — genau dort, hatte ich gesagt, und er hielt es. Das Holzschwert in beiden Händen, zu fest, die Knöchel weiß. Zwölf Kirchensoldaten und ein Inquisitor, und Finn mit seinem Holzschwert das kein System-Upgrade hatte und kein Level und keine Klasse.

Er hatte trotzdem nicht gezittert.

Nicht das Schwert — seine Hände. Seine Hände zitterten. Aber er hielt.

Ich hatte keine Zeit ihm zu sagen was das bedeutete.

Ich hatte keine Zeit für vieles.

Aber ich merkte es. Und speicherte es.

Finn, mit zitternden Händen, der nicht zurückwich. Das war, entschied ich, mutiger als alles was ich je mit einem Status-Fenster gesehen hatte.`,
 choices: [{ text: "→ Der Plan", next: "a2k5_taktik" }],
 },

 a2k5_finn_geht: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "»Geh.«",
 scene: "Dorfzentrum, Millheim",
 bg: "chaos", music: "theme_family",
 text: `Finn ging.

Das kostete ihn mehr als er zeigte — ich sah es an der Art wie er sich umdrehte. Zu schnell. Als würde er sich selbst zwingen bevor er es sich anders überlegte.

Er schaute nicht zurück.

Das war richtig. Wer zurückschaut, bleibt manchmal.

Ich wandte mich den Soldaten zu. Zwölf. Ein Inquisitor. Roland in System-Stasis.

Das Terminal öffnete sich automatisch: \`SITUATION: KRITISCH. OPTIONEN: 4.\`

Ich schloss es. Ich wusste meine Optionen.

Irgendwo hinter mir war Finn, der davonlief und es hasste und es trotzdem tat, weil ich ihn darum gebeten hatte.

Das gab mir, unerwartet, Gewissheit.

Wenn Finn mir vertraute genug um zu gehen — dann konnte ich das hier schaffen.`,
 choices: [{ text: "→ Der Plan", next: "a2k5_taktik" }],
 },

 a2k5_finn_schwert: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "Das Holzschwert",
 scene: "Dorfzentrum, Millheim",
 bg: "chaos", music: "theme_family",
 text: `Finn schaute sein Holzschwert an.

Lang. Als würde er eine Frage stellen die das Schwert nicht beantworten konnte.

Dann nickte er. »...Ruf mich, wenn du mich brauchst.«

Er ging. Schnell, mit dem Schritt von jemandem der nicht langsamwerden darf, weil er dann stoppt.

Ich schaute auf das Holzschwert in meinem Kopf — das Bild davon. Level 0. Keine Klasse. Keine Rune. Ein Kind das ein Stück Holz in Form gebracht hatte und damit Goblins übte.

Und trotzdem: Finn war der Einzige von allen hier der mir nicht befohlen hatte was ich zu tun hatte. Der gefragt hatte ob er helfen konnte. Der, als ich nein gesagt hatte, gegangen war.

Das Holzschwert bedeutete nichts.

Finn bedeutete alles.

Das Terminal: \`SITUATION: KRITISCH. OPTIONEN: 4.\`

Ich öffnete es. Ich wusste meine Optionen.`,
 choices: [{ text: "→ Der Plan", next: "a2k5_taktik" }],
 },
...
»Dann muss ich dich—«`,
 ...
 bg: "chaos",
 music: "theme_family",
 text: `Vex' Schwert hing in der Luft.

Zwischen der Klinge und Rolands Kehle: zehn Zentimeter. Zwischen dem Tod meines Vaters und allem anderen: eine Sekunde.

Ich stand dort. Sieben Jahre alt. Kein Schwert. Keine Klasse. Kein Status. Das System existierte für mich nicht — und ich existierte nicht für das System.

Das war normalerweise ein Nachteil.

In diesem Moment war es das Einzige, das zählte.

Vex schaute mich an. Er hatte meinen Status gescannt. Er hatte NICHTS gesehen. Keine Klasse, kein Level, keine Magie. Für das System war der Junge, der gerade zwischen ihm und seinem Ziel stand, nicht existent.

Für mich war er ein Level-58-Inquisitor mit einer schwachen linken Seite, einem Schwert-Cooldown von drei Sekunden, und der Erschöpfung von jemandem der drei Stunden kämpft.

Mein Terminal öffnete sich.
...
Ich hatte weniger als eine Sekunde.`,
 ...
 text2: `\`\`\`
> VOID-TERMINAL — NOTFALL-ANALYSE
>
> SITUATION: Träger eingeschlossen.
> STATUS ROLAND ASHFORD: System-Einfrierung aktiv (6 Sek. verbleibend)
> STATUS VEX: Schwert gezogen. Intent: TÖDLICH.
>
> OPTIONEN ANALYSIERT:
>
> OPT A) [Aether.Resonance] INSTINKTIV — RISIKO: UNBEKANNT
> → System-unabhängig. Außerhalb der Vorhersagemodelle.
>
> OPT B) ALDWIN — Kontaktpunkt: AKTIV
> → Kosten: Aldwins Tarnung. Permanent.
>
> OPT C) GREGOR — Physisch, unbewaffnet
> → Kosten: Ein 74-jähriger Mann zwischen Stahl.
>
> OPT D) [Code.Modify] ERZWINGEN — GESPERRT
> → Warnung: Organschäden möglich.
> → Warnung: Systemdetektion sicher.
> → Warnung: Träger möglicherweise bewusstlos.
>
> EMPFEHLUNG: Keine.
> Alle Optionen tragen Kosten.
> Alle Kosten sind real.
> Die Wahl gehört dem Träger.
\`\`\``,
 ...
 alignEffect: { schatten: 3, chaos: 3 },
 ...
 a2k5_rettung_aether: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "Der Aether antwortet",
 scene: "Dorfzentrum, Millheim — der Moment",
 bg: "chaos", music: "theme_void_terminal",
 text: `Ich bat nicht.

Ich hatte keine Sprache dafür. Keine Worte, keine Geste, keine Formel. Ich war sieben Jahre alt und stand zwischen einer Klinge und meinem Vater und das Einzige was ich hatte war das Terminal.

Das Terminal war leer.

Ich öffnete es trotzdem. Und schrieb — nicht Code, nicht Befehl — einfach: *nein.*

Was dann passierte, kann ich bis heute nicht vollständig beschreiben.

Der Aether *hörte zu.*

Nicht das System — der Aether selbst. Das rohe, prä-systemische Substrat unter allem. Der Stoff aus dem Aethermere gemacht war, bevor irgendjemand begonnen hatte, Regeln darüber zu schreiben.

Vex' Schwert prallte ab. Nicht blockiert — *verweigert*. Als hätte die Luft selbst entschieden, dass diese Klinge hier nicht existieren durfte.

Ein Licht. Nicht Magie — etwas älter als Magie. Warm, kurz, schon wieder weg.

Vex flog zurück. Drei Meter. Landete auf dem Rücken und blieb dort.

Roland, dessen Einfrierung in dem Moment brach, schaute seinen Sohn an.

Sein Sohn schaute auf seine eigenen Hände.

Das Terminal: \`WARNUNG: AETHER-DIREKTZUGRIFF. DIESE FÄHIGKEIT EXISTIERT NICHT IN DER DATENBANK. KEINE WEITERE DOKUMENTATION MÖGLICH.\`

Kaito schloss das Terminal.

Das würde sich erklären lassen. Irgendwann.

Nicht jetzt.`,
 choices: [{ text: "→ Die Nachwirkungen", next: "a2k5_nachwirkungen" }],
 },

 a2k5_rettung_aldwin: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "Aldwin",
 scene: "Dorfzentrum, Millheim — der Moment",
 bg: "chaos", music: "theme_void_terminal",
 text: `Aldwin hob eine Hand.

Das war alles. Eine Hand, ausgestreckt, Handfläche zu Vex.

Was danach passierte geschah schnell.

Vex flog. Nicht fiel — *flog*, wie ein Objekt das jemand wirft dem Schwerkraft egal ist. Er landete am anderen Ende des Platzes, stand wankend auf, sah Aldwin, und erstarrte.
...
»Ja«, sagte Aldwin. Ruhig. Mit der Ruhe eines Mannes dem sehr viele Dinge gleichgültig geworden waren weil er zu lange gelebt hatte um sich noch aufzuregen.

Das freundliche Lehrergesicht war verschwunden.

Darunter: etwas das man nicht in zwei Worten beschreiben konnte. Vierhundert Jahre. Erschöpfung. Die Art Macht die sich anfühlte wie Stille statt wie Lärm.

Level 89.

Vex, Level 58, drehte sich um und lief.

Aldwin schaute dem davonlaufenden Inquisitor nach. Dann schaute er Kaito an.

»Das war teuer«, sagte er.
...
Aldwin nickte einmal. Die Art Nicken die sagt: wir reden nicht mehr darüber. Dann wandte er sich der Menge zu und begann zu erklären, wie es sich anfühlte, den Dorflehrer um vierhundert Jahre unterschätzt zu haben.`,
 choices: [{ text: "→ Die Nachwirkungen", next: "a2k5_nachwirkungen" }],
 },

 a2k5_rettung_gregor: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "Gregor",
 scene: "Dorfzentrum, Millheim — der Moment",
 bg: "chaos", music: "theme_gregor",
 text: `Gregor trat vor.

Nicht schnell. Nicht heroisch. Mit dem Gang eines 74-jährigen Mannes der weiß was er tut und kein besonderes Bedürfnis hat, es dramatisch aussehen zu lassen.

Er stellte sich zwischen Vex und Kaito.

Keine Waffe. Kein Skill. Nur ein alter Mann in einem abgewetzten Mantel, der einem Inquisitor-Schwert gegenüberstand.

»Du willst ein Kind töten, Inquisitor?«

Vex zögerte.

»Vor dem ganzen Dorf?«

Das war der Moment. Nicht die Macht, nicht die Magie — die *Öffentlichkeit*. Vex hatte eine Mission gehabt, aber er hatte keine Genehmigung gehabt, einen Zeugen zu erschaffen.

Fünf Sekunden Zögern.

Dann schlug er Gregor beiseite.

Nicht vorsichtig. Mit dem Arm, hart, wie man etwas wegwirft das im Weg steht.

Gregor fiel. Ein Geräusch das ich nie vergessen würde — nicht laut, gerade das war das Schlimme.

Roland brach in diesem Moment aus der System-Einfrierung. Pure Willenskraft, die Zahl die sein Level zeigte bedeutungslos in diesem Augenblick. Er griff Vex.

Der Kampf war kurz.

Ich stand und schaute Gregor an, der auf dem Boden lag und mich ansah und sagte: »Macht euch keine Sorgen. Ich bin gestürzt.« Als wäre das, was gerade passiert war, ein Unfall.

Das Terminal: \`GREGOR SYLVAINE — STATUS: VERLETZT. SCHWERE: KRITISCH.\`

Ich schloss es. Ich wollte keine Zahlen dafür.`,
 choices: [{ text: "→ Die Nachwirkungen", next: "a2k5_nachwirkungen" }],
 },

 a2k5_rettung_void: {
 act: "AKT II", chapter: "Kapitel 9 — System.Crash()", title: "Code.Modify",
 scene: "Dorfzentrum, Millheim — der Moment",
 bg: "void", music: "theme_void_terminal",
 text: `Das Terminal explodierte in Warnungen.

\`\`\`
> [Code.Modify] — ZUGRIFF VERWEIGERT
> Skill gesperrt: System-Sicherheitsprotokoll Ebene 7
> Warnung: Erzwungener Zugriff möglich
> Warnung: Organschäden wahrscheinlich
> Warnung: System-Detektion: SICHER
> Warnung: Träger möglicherweise: BEWUSSTLOS
>
...
Was folgte, war eine Sekunde.

Eine Sekunde in der das System *mich* sah — wirklich sah, zum ersten Mal, einen Blick der sich anfühlte wie heißes Metall — und ich das System manipulierte.

Vex' Magie brach zusammen. Nicht geschwächt — *annulliert*. Als hätte jemand den Stecker gezogen. Seine Einfrierung auf Roland: weg. Seine Scan-Skills: weg. Seine System-Verbindung: für 4,3 Sekunden vollständig getrennt.

Roland war frei. Roland war schnell.

Ich war keines von beiden.

Das Letzte woran ich mich erinnerte: der Boden. Dann Miras Stimme irgendwo über mir. Dann: nichts.

Ich wachte in meinem Bett auf. Mira saß neben mir auf dem Boden, meine Hand in beiden ihren, und summte eine Melodie die ich aus Gregor-Dienstagen kannte.

»Buda schläft«, hatte sie zu jemandem gesagt der nicht da war. »Buda wird gut.«

Mein linker Arm funktionierte zwei Tage nicht richtig. Meine Schläfen pochten eine Woche.

Das Terminal zeigte: \`System-Detektion: AKTIV. Ein Bericht existiert.\`

Ich hatte Vex besiegt.

Ich hatte auch das Erste getan, was ich schwören wollte nie zu tun: mich sichtbar gemacht.`,
 choices: [{ text: "→ Die Nachwirkungen", next: "a2k5_nachwirkungen" }],
 },
...
Er hatte mich angeschaut — als ich zur Tür hereinkam — und ich wusste sofort, dass er es wusste. Nicht das er sterben würde. Wann.

»Komm her, Junge. Setz dich. Die Zeit ist kurz, also hör gut zu.«

Mira saß auf der anderen Seite des Betts, ihre kleine Hand auf seinem Arm. Sie verstand nicht was passierte. Ihr Gesicht war offen, neugierig, ein Kind das einen schlafenden Großvater wecken will.

Ich setzte mich.

»Das Buch. Hast du es noch?«

»Ja.«

»Lies Seite 47 noch einmal. Wenn du allein bist. Wenn du denkst, du weißt was du tust. Lies sie wieder.«

Ich nickte. Gregors Augen waren klar. Klarer als je zuvor — als hätte der Körper aufgehört sich anzustrengen und dem Geist alles überlassen.

»In meinem ersten Leben«, sagte er, »War ich Soldat. Ich habe Dinge getan die ich nicht vergessen kann. Dann war ich Opa. Das war besser.«

Er hustete. Elena legte eine Hand auf seine Schulter — leicht, als würde sie etwas Zerbrechliches berühren.

»Ich hatte Angst vor dir, am Anfang.« Er sagte es ohne Umschreibung. »Ein Kind das nicht weint. Das die Welt analysiert wie ein alter Mann. Das hat mir Angst gemacht.«

Er schaute mich an.

»Aber dann habe ich gesehen wie du Mira anschaust. Und wie du Sera anschaust. Und wie du deinen Vater anschaust wenn er trainiert und denkt, niemand sieht zu.«

Er schloss kurz die Augen.

»Du liebst sie. Auf deine Art. Das hat meine Angst abgelöst.«

Mira zog an seinem Ärmel. »Opa. Erzähl eine Geschichte. Bitte.«

Gregor lächelte — das Lächeln das er nur für sie hatte. Das warme, echte, ein bisschen törichte.

»Gut. Eine Geschichte.« Er holte Atem. Dünn. Aber da. »Es war einmal ein kleiner Stern. Der kleinste. Der heller leuchtete als alle anderen. Die großen Sterne fragten: 'Wie machst du das?' Und der kleine Stern sagte...«

Er wartete. Wie immer. Mira lehnte sich vor.

»Was hat er gesagt, Opa?«

Gregor schaute mich an. Nicht Mira.

Mich.

»Er sagte: 'Ich leuchte nicht für mich. Ich leuchte für die, die im Dunkeln stehen.'«

Seine Hand wurde locker auf Miras Arm.
...
Ich stand auf und ging zum Fenster. Nicht weil ich nicht weinte — sondern weil ich nicht wollte dass Mira mich sah. Mira, die noch nicht verstand, dass manche Geschichten enden ohne Auflösung.

Elena stand an der Wand. Ich hörte sie nicht weinen. Das war schlimmer.

Roland: die Hände zu Fäusten. Er öffnete den Mund. Schloss ihn wieder. Dreimal.

Draußen fiel Schnee. Der erste Schnee des Jahres, in Millheim, das wir morgen verlassen würden.

Ich öffnete das Terminal. Nicht um etwas zu tun. Nur weil ich nicht wusste, was ich sonst tun sollte.

Es war leer.

Und blieb es.

Dann — nach einer langen Weile — erschien eine Zeile:`,

 textConditional: {
 gregor_verletzt: `Opa Gregor lag im Bett. Das Gleiche. Aber mit einer anderen Stille darum.

Der Schlag des Inquisitors hatte etwas zerbrochen, das Elena nicht heilen konnte. Nicht mangels Fähigkeit — weil manche Dinge sich nicht heilen lassen. Nicht in einem 74-jährigen Körper der genug getragen hatte.

Er wusste es. Wir alle wussten es.

Gregor schaute mich an — direkt, klar — und ich sah darin keine Angst. Nur Erschöpfung. Die Art die sagt: Es ist genug. Ich war lang genug hier.

»Das Buch. Hast du es?« Erste Worte. Immer praktisch.

»Ja.«

»Seite 47. Erst wenn du allein bist.«

»Ja.«

»Gut.« Er schloss die Augen. Öffnete sie wieder. »Ein letztes Märchen, Junge. Hör zu.«

»...Ja, Opa.«

»Es war einmal ein kleiner Stern...«

Ich kannte das Ende dieser Geschichte. Ich kannte es schon immer.

Aber ich ließ ihn erzählen. Bis seine Hand locker wurde. Bis Mira fragte: »Opa, die Geschichte ist noch nicht fertig.«

Bis die Antwort ausblieb.`,
 default: ``,
 },
...
»Mach die Welt da draußen ein bisschen besser, ja?«`,
 ...
 choices: [
 {
 text: "A) »Ich komme zurück.« — Du weißt nicht ob das wahr ist. Du sagst es trotzdem.",
 ...
 narrativeFeedback: "Boris: »Immer.« Ein Wort. Er wendet sich ab — bevor es mehr werden kann.",
 },
 {
 ...
 flagEffect: { borisVersprechen: false },
 alignEffect: { licht: 1 },
 narrativeFeedback: "Boris erwidert die Verbeugung. Das Dorf sieht es. Niemand spricht. Das ist mehr Abschied als tausend Worte gewesen wären.",
 },
 ]
 },
...
»Und: In drei Jahren — wenn du zehn bist — wird die Kirche neue Helden beschwören. Und DU wirst dabei sein. Nicht als Zuschauer. Als BEOBACHTER. Um zu verstehen, was das System wirklich ist.«`,
 ...
 choices: [
 {
 text: "A) NACH VORNE: »Nicht zurückschauen. Was hinter mir liegt, bleibt dort.«",
 desc: "Kaito schaut kein einziges Mal zurück. Das ist keine Härte. Das ist eine Entscheidung.",
 next: "a2k7_letzter_blick",
 alignEffect: { schatten: 2, verborgenheit: 1 },
 flagEffect: { abschiedsHaltung: "voran" },
 narrativeFeedback: "Er schaut nicht zurück. Dreißig Menschen die gehen, und er der Einzige der den Blick vorwärts hält. Finn bemerkt es. Sagt nichts. Das ist Finns Art zu sagen: Ich sehe dich.",
 },
 {
 text: "B) DANKBAR: Du nimmst dir einen Moment. Millheim war sieben Jahre. Das verdient eine Sekunde.",
 desc: "Nicht Nostalgie — Anerkennung. Der Unterschied ist klein, aber er ist da.",
 next: "a2k7_letzter_blick",
 alignEffect: { licht: 2 },
 affinityEffect: { gregor: 10, elena: 5 },
 flagEffect: { abschiedsHaltung: "dankbar" },
 narrativeFeedback: "Eine Sekunde. Dann geht er weiter. Gregor wäre zufrieden, wenn er es sähe.",
 },
 {
 text: "C) ANALYTISCH: Du verarbeitest Millheim wie Daten. Sieben Jahre Input. Gut gespeichert.",
 desc: "Nicht Kälte — das Einzige was Kaito kennt, das nicht weint. Das Terminal speichert. Er auch.",
 next: "a2k7_letzter_blick",
 alignEffect: { ordnung: 2 },
 flagEffect: { abschiedsHaltung: "analytisch" },
 narrativeFeedback: "Das Terminal: 'Millheim — Archiviert.' Du löschst den Eintrag sofort. Manche Dinge gehören nicht ins Terminal.",
 },
 {
 text: "D) ALLEIN: Irgendwo auf dem Weg trennst du dich. Die anderen merken es zu spät.",
 desc: "Elena schaut den leeren Platz an wo Kaito war. Sagt nichts. Nickt nur.",
 next: "a2k7_letzter_blick",
 alignEffect: { schatten: 3, verborgenheit: 2 },
 affinityEffect: { elena: -10, roland: -5, finn: -10 },
 alignEffect: { schatten: 3, chaos: 2, verborgenheit: 2 },
 flagEffect: { abschiedsHaltung: "allein" },
 narrativeFeedback: "Elena schaut ihn lange an. Dann nickt sie. »Ich weiß.« Sie sagt nicht: bleib. Sie sagt nicht: geh nicht. Nur: ich weiß.",
 },
 ]
 },
