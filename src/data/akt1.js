...
export const AKT_I = {
 ...
 textConditional: { reue: `Das Erste: Erleichterung. Als hätte ein Teil von mir gewusst dass er eine zweite Chance bekam.`, hingabe: `Das Erste: Entschlossenheit. Dieselbe wie beim letzten Bug. Nur mit mehr Zeit.`, einsamkeit: `Das Erste: Elenas Stimme. So hatte noch niemand für mich gesungen.`, akzeptanz: `Das Erste: Stille — die gute Art. Du bist angekommen.`, default: `` },
 bg: "light",
 music: "theme_family",
 text: `Licht.
...
Zum ersten Mal seit langem... friedlich.`,
 ...
 choices: [{ text: "→ Der erste Dienstag", next: "a1_gregor_erste_begegnung" }],
 ...
 title: "Der Mann mit den Märchen",
 scene: "Gregors Haus, Millheim — Alter: 4 Monate",
 bg: "cottage",
 music: "theme_gregor",
 text: `Gregor Sylvaine war achtundsechzig Jahre alt, hustete zu oft und hatte die Augen eines Mannes, der zu viel gesehen hatte und darüber nachgedacht hatte, ob das gut war.

Er kam jeden Dienstag.

Elena öffnete die Tür, er trat ein, setzte sich in denselben Stuhl, und erzählte — nicht den Eltern. Er erzählte dem Baby. Das war, erklärte er niemandem, weil er der Meinung war, dass Babys am besten zuhörten. Sie konnten nicht widersprechen.

Kaito hörte zu.

Nicht wie ein Baby zuhört — mit dem offenen, leeren Gesicht das Neues verarbeitet. Sondern konzentriert. Aufmerksam. Gregors Stimme analysierend wie ein Programm das nach Mustern sucht.

Er fand Muster.

Gregors Märchen hatten keine Helden. Sie hatten Menschen, die Fehler machten und damit lebten. Märchen über einen König der zu stolz war um Hilfe anzunehmen. Über eine Magierin die ihre Kraft verlor und entdeckte, dass sie ohne sie mehr war. Über einen Stern der kleiner als alle anderen war.

Das waren keine Kindermärchen. Das waren... Memoranden. Verschlüsselte Botschaften, verkleidet als Geschichten.

Eines Abends — Gregor hatte gerade das Ende einer langen Geschichte über eine Prinzessin erzählt die das falsche Königreich rettete und das richtige vergaß — hob Kaito die Hand.

Nicht reflexartig. Bewusst. Er hob die Hand, wie man sie hebt wenn man eine Frage hat.

Gregor sah es.

Kein Erschrecken. Kein »Das ist merkwürdig für ein Baby«. Er schaute nur auf die kleine Hand und nickte, als bestätige er eine Vermutung die er schon länger hatte.

»Ja«, sagte Gregor. »Ich weiß.«

Er blieb noch eine Stunde. Und erzählte diesmal anders — langsamer, mit mehr Details, als würde er jemandem erzählen der versteht.

Als er ging, sagte er zu Elena: »Er ist ein ungewöhnliches Kind.«

Elena: »Ich weiß.«

»Gut.« Er setzte seinen Hut auf. »Dann passt ihr gut zusammen.«`,
 choices: [{ text: "→ Das erste Jahr vergeht", next: "a2_familie_montage" }],
 },
...
Jetzt: Wie verhältst du dich in den nächsten Monaten?`,
 ...
 choices: [
 {
 text: "A) VORSICHTIG: Du spielst das normale Baby. Zeigst nichts.",
 desc: "Du sagst das Wort. Lässt dich anstarren. Und entscheidest dich dann — bewusst — es nie wieder zu tun. Nicht so. Nicht wirklich.",
 next: "a1_wanderhaendler",
 alignEffect: { verborgenheit: 4 },
 flagEffect: { kindheitsVerhalten: "vorsichtig", ersteUnterdrückung: true },
 narrativeFeedback: "Du öffnest den Mund. Schließt ihn wieder. Das erste Mal. Es wird nicht das letzte Mal sein. Roland lehnt zurück, entspannt. Er weiß nichts. Das ist die Absicht. Und zum ersten Mal weißt du: du kannst lügen ohne es zu sagen.",
 },
 {
 text: "B) NEUGIERIG: Du greifst nach Büchern. Du schaust auf Gesichter, nicht auf Spielzeug.",
 desc: "Subtil. Aber Gregor hat das ganze Leben damit verbracht, auf Dinge zu achten, die andere übersehen. Er schaut dich an mit dem Blick, den er sonst für Rätsel reserviert.",
 next: "a1_wanderhaendler",
 alignEffect: { ordnung: 2 },
 affinityEffect: { gregor: 15, elena: 5 },
 flagEffect: { kindheitsVerhalten: "neugierig", gregorAufmerksam: true },
 narrativeFeedback: "Gregor beugt sich vor. Hebt den Finger. Dann — sagt er nichts. Aber sein Blick bleibt auf dir. Du hast etwas ausgelöst. Du weißt noch nicht was. Das macht es schlimmer, nicht besser.",
 },
 {
 text: "C) OFFEN: Du sprichst klar. Zu früh. Zu deutlich. Du schaust Aldwin direkt in die Augen.",
 desc: "Roland wird blass. Elena weint — nicht aus Freude. Du bist sechs Monate alt und hast gerade deine Familie erschrocken. Das lässt sich nicht zurücknehmen.",
 next: "a1_wanderhaendler",
 ...
 narrativeFeedback: "Rolands Gesicht zeigt für einen Moment etwas, das er nie zeigt: Angst. Nicht für sich. Für dich. Elena presst dich an sich, fester als nötig. Gregor schaut dich an und sagt leise: 'Interessant.' Das klingt nicht wie ein Kompliment.",
 },
 ]
 },
...
Nah genug.`,
 ...
 choices: [
 {
 text: "A) Schweigen. Du weißt es. Du sagst nichts. Du wirst nie sagen, dass du es weißt.",
 desc: "Das ist die erste Lüge. Nicht aus Bösartigkeit — aus Schutz. Aber es ist trotzdem eine Lüge, und du weißt es.",
 next: "a4_mira_geburt",
 alignEffect: { schatten: 2, verborgenheit: 2 },
 affinityEffect: { roland: -5 },
 flagEffect: { rolandFluchWissen: "verschwiegen", erstesGeheimnis: true },
 narrativeFeedback: "Du schließt das Terminal. Legst dich zurück. Sein Vater. Verflucht. Du wirst nichts sagen — nicht bis du etwas tun kannst. Und wenn du es nie kannst: auch dann nicht.",
 },
 {
 text: "B) Du streckst deine winzige Hand aus. Nicht um zu reden. Nur um zu berühren.",
 desc: "Roland schaut seinen Sohn an. Er versteht nicht warum. Aber sein Griff um deine Hand ist fest.",
 next: "a4_mira_geburt",
 alignEffect: { licht: 2 },
 affinityEffect: { roland: 25 },
 flagEffect: { rolandFluchWissen: "beruehrung" },
 narrativeFeedback: "Rolands Hand umfasst deine. Er weiß nicht was du weißt. Das macht es schwerer, nicht leichter. Er lächelt dich an — das seltene Lächeln. Du lächelst zurück und denkst an einen Namen: Vex.",
 },
 {
 text: "C) Du beschließt etwas. Kein Wort. Kein Terminal-Eintrag. Vex wird zu mehr als einem Namen.",
 desc: "Du bist 14 Monate alt. Du hast gerade deinen ersten Feind. Das ist früh. Das ist richtig.",
 next: "a4_mira_geburt",
 alignEffect: { schatten: 3, ordnung: 1 },
 flagEffect: { rolandFluchWissen: "rache", vexGemerk: true },
 narrativeFeedback: "Das Terminal versucht 'Vex' als Objective zu loggen. Du löschst den Eintrag. Manche Dinge sind keine Aufgaben.",
 },
 ],
...
Wie reagierst du auf Mira?`,
 ...
 alignEffect: { licht: 2 },
 narrativeFeedback: "Mira greift nach deinem Finger. Ihr Griff ist fest — erstaunlich fest. Elena atmet scharf ein. Dann lacht sie leise.",
 },
 {
 ...
 narrativeFeedback: "Das Terminal flimmert. Dann, in kleiner Schrift: »...Das Terminal empfiehlt, sie nicht zu scannen. Sie ist kein Objekt.« Kaito klappt das Fenster zu.",
 },
 {
 ...
 alignEffect: { licht: 1 },
 narrativeFeedback: "Roland dreht sich zur Wand. Seine Schultern zucken — er weint, ganz still, damit niemand es sieht.",
 },
 ]
 },
 ...
 textConditional: { beruehrung: `Beim Scan sah ich warum meine Hand gezittert hatte. Ihr Code war anders. Warm. Als würde er atmen.`, schwester: `Ich hatte »Schwester« gesagt ohne zu wissen warum. Jetzt sah ich es im Code. Ich hatte es gewusst.`, default: `` },
 bg: "cottage",
 music: "theme_void_terminal",
...
Für die Familie, die ich im ersten Leben nie hatte.`,
 ...
 choices: [
 {
 text: "A) Nichts tun. Du bist drei. Warten ist das Einzige, das du kannst.",
 desc: "Du wartest. Nicht aus Angst — aus Kalkül. Du hast keine Werkzeuge. Du sammelst Informationen. Und du übst, stillzuhalten, wenn alles in dir schreit.",
 next: "a2k1_morgenroutine",
 alignEffect: { ordnung: 2, verborgenheit: 2 },
 flagEffect: { beobachterReaktion: "warten" },
 narrativeFeedback: "Du atmest aus. Wartest. Der Scan zieht weiter. Du bist drei Jahre alt und hast gerade gelernt, dass Geduld sich anfühlt wie Schmerz — aber Schmerz der einen Zweck hat.",
 },
 {
 text: "B) Du versuchst den Scan mit [Code.Read] zu analysieren. Du kannst nicht viel. Du tust es trotzdem.",
 desc: "Es funktioniert nicht richtig. Du bist drei. Aber das Terminal registriert den Versuch. Und du auch.",
 next: "a2k1_morgenroutine",
 alignEffect: { schatten: 2, chaos: 1 },
 flagEffect: { beobachterReaktion: "analyse", codeReadFrüh: true },
 narrativeFeedback: "Der Scan ist zu schnell, zu komplex. Du bekommst ein Fragment — einen Bruchteile einer Klasse-Signatur. Militärisch. Oder Kirchlich. Das Terminal: 'Analyse unvollständig.' Du merkst dir trotzdem alles was du hast.",
 },
 {
 text: "C) Du tust so als würdest du schlafen. Vollständig. Überzeugend. Dein erster echter Verstellungsversuch.",
 desc: "Du bist drei. Aber du weißt bereits: die überzeugendste Lüge ist die, die niemand für eine Lüge hält.",
 next: "a2k1_morgenroutine",
 alignEffect: { verborgenheit: 3, schatten: 1 },
 flagEffect: { beobachterReaktion: "tarnung", tarnungFrüh: true },
 narrativeFeedback: "Der Scan geht über dich hinweg. Registriert: Kind, schlafend, keine Anomalie. Das Terminal flüstert: 'Code.Spoof — Grundform erkannt.' Du öffnest ein Auge. Schließt es wieder. Das war Test Nummer eins.",
 },
 ],
