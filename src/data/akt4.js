...
Terminal: »...Das ist entweder brilliant oder schrecklich.«
...
»ZWEITE PRÜFUNG: MITGEFÜHL. WARUM WILLST DU DAS SYSTEM VERÄNDERN?«`,
  ...
  a4k8_wächter_opfer: {
    ...
    textConditional: { persoenlich: `Der Raum wurde wärmer. Als würde etwas sehr Altes eine Antwort akzeptieren die es nicht erwartet hatte.`, universal: `»Alle ist abstrakt. Nenn ein Gesicht.« Ich nannte Miras. Das reichte.`, philosophisch: `»Deine Begründung hat keine Schwachstelle.« Das komplizierteste Kompliment das ein Wächter-Konstrukt je gemeint hatte.`, default: `` },
    bg: "void",
    music: "theme_family",
