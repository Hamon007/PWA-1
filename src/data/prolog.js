...
Der Server im Keller begann zu heulen — ein mechanisches Kreischen, das durch die Decke drang. Kaitos Monitore flackerten. Auf dem mittleren Bildschirm erschien eine Fehlermeldung.`,
 ...
 p0_flucht: {
    act: "PROLOG", chapter: "Kapitel 0 — Freitag, 23:47 Uhr", title: "Zum Ausgang",
    scene: "Büro — Korridor, Treppenhaus",
    text: `Kaito warf den Stuhl zurück und lief.

Durch den Korridor. Am Aufzug vorbei — zu langsam — die Treppe runter. Erste Etage. Notausgang.
...
Sie führte nach unten. In einen Keller, den sein Gebäude laut Grundriss nicht hatte.

Kaito schaute auf die Tür. Auf das Schild. Auf die Treppe die in die Tiefe führte.

Das Summen kam von dort unten.

Er stand zehn Sekunden. Dann ging er hinunter.`,
    choices: [{ text: "→ Der Keller", next: "p0_keller" }],
 },

 p0_weitertippen: {
    act: "PROLOG", chapter: "Kapitel 0 — Freitag, 23:47 Uhr", title: "Noch eine Zeile",
    scene: "Büro — Schreibtisch",
    text: `Kaito tippte weiter.

Produktionscrash. Feature-Freeze. Frist gestern. Das Licht pulsierte — wahrscheinlich ein Gewitter, wahrscheinlich Straßenreflexion, wahrscheinlich war alles in Ordnung.

Er schrieb drei Zeilen Code. Fand einen Fehler. Korrigierte ihn. Zwei neue erschienen.

Das Licht wurde stärker.

Eine Zeile. Nur noch eine Zeile.

Dann: der Bildschirm erlosch. Alle Bildschirme. Das gesamte Stockwerk — dunkel.

Nur das Licht aus dem Boden blieb. Pulsierte. Warm.

Kaito schaute auf seinen unvollendeten Code — verschwunden im schwarzen Bildschirm.
