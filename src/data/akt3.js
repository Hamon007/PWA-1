...
Aldwin lächelte — zum ersten Mal seit Millheim. »Dann geh.«`,
 ...
 narrativeFeedback: "Aldwins Kontaktnetz sorgt für die nötige Empfehlung. Fünf Jahre vorbereiten — dann der Brief.",
 },
 ...
 narrativeFeedback: "Meridia. Der Name fällt aus Aldwins Bericht heraus wie etwas, das schon immer da war.",
 },
 { text: "C) Über die Zwerge — Gorricks Netzwerk hat Zugänge, die auf keiner Karte stehen.",
 next: "a3k0_weg_zwerge",
 affinityEffect: { aldwin: 5 },
 alignEffect: { schatten: 2 },
 flagEffect: { zugangsWeg: "zwerge" },
 narrativeFeedback: "Frau Voss kennt einen Kontakt. Einen Zwergschmied, der der Akademie Material liefert. Nützlich.",
 },
 { text: "D) Auf eigene Faust — kein Empfehlungsbrief, kein Netzwerk. Kaito findet einen Weg.",
 next: "a3k0_weg_solo",
 alignEffect: { schatten: 3, verborgenheit: 1 },
 flagEffect: { zugangsWeg: "solo" },
 narrativeFeedback: "Frau Voss schaut ihn lange an. »Du bist entweder sehr mutig oder sehr dumm.« Pause. »Gut. Beides ist brauchbar.«",
 },
 ],
 },
 ...
 a3k0_weg_akademie: {
 act: "AKT III", chapter: "Fünf Jahre — Kreuzweg", title: "Der offizielle Weg",
 scene: "Kreuzweg — fünf Jahre im Schnelldurchlauf",
 bg: "city", music: "theme_family",
 text: `Fünf Jahre.

Frau Voss hatte die Empfehlung arrangiert — anonym, über Umwege, mit der gereizten Effizienz einer Frau, die schon zu viele Formulare für Leute ausgefüllt hatte, die die Formulare nicht ausfüllen konnten.

Der Empfehlungsbrief: *Außergewöhnliches Systemverständnis. Empfohlen zur Aufnahme in die Imperiale Akademie — höchste Priorität.*

Absender: [Unbekannte Institution].

»Wer hat den Brief unterschrieben?«, fragte Kaito Frau Voss.

»Niemand der existiert«, sagte Frau Voss. »Und doch jemand, dem die Akademie glaubt.«

Fünf Jahre in Kreuzweg: Tarnung perfektionieren. System-Infrastruktur kartographieren. Aldwins Netz kennenlernen — drei Dutzend Menschen in vier Provinzen, die alle Dinge tun, die das System nicht sieht.

Als der Brief ankam, war Kaito zwölf Jahre alt und konnte einen Rang-B-Scanner in 0,3 Sekunden täuschen.
...
Das reichte.`,
 ...
 a3k0_weg_elfen: {
 act: "AKT III", chapter: "Fünf Jahre — Kreuzweg", title: "Das Elfennetz",
 scene: "Kreuzweg — und weiter",
 bg: "village", music: "theme_elena_song",
 text: `Meridia.

Der Name tauchte in Aldwins Brief auf wie etwas, das schon immer da gewesen war — nur dass niemand laut darüber gesprochen hatte.

*Imperiale Chronistin. Rang A. Vierhundert Jahre alt. Sie wartet.*

Wartet. Als hätte sie das schon vorher gewusst.

Der Weg zur Akademie war lang und indirekt: erst zu einem elfischen Archiv im Norden, wo Meridias Kontakte drei Monate lang Kaitos falschen Lebenslauf aufbauten — Noten, Empfehlungen, eine Biografie, die jede Überprüfung überstand. Dann, über einen Händler der Bücher nach Aetheria Prime lieferte, die Einladung.

Keine offizielle Empfehlung. Besser: eine inoffizielle, die sich offiziell anfühlte.

Frau Voss: »Du lernst schnell.«
Kaito: »Ich lerne von guten Lehrerinnen.«
Frau Voss: »Schmeichelei. Ich mag es trotzdem.«

Als er zwölf war, kannte er mehr von Aethermeres System-Infrastruktur als die meisten Akademie-Absolventen.

Die Einladung kam im Frühling.`,
 choices: [{ text: "→ Aetheria Prime", next: "a3k1_aetheria" }],
 affinityEffect: { meridia: 10 },
 },

 a3k0_weg_zwerge: {
 act: "AKT III", chapter: "Fünf Jahre — Kreuzweg", title: "Gorricks Kontakt",
 scene: "Kreuzweg — die Unterstadt",
 bg: "city", music: "theme_void_terminal",
 text: `Frau Voss kannte einen Zwerg.

Natürlich kannte sie einen Zwerg. Frau Voss kannte jeden, der irgendetwas außerhalb der System-Zuständigkeit lieferte.

Brummel Eisenfaust, Materialhändler, lieferte seit zwanzig Jahren Runen-Metall an die Akademie. Er kannte jeden Lageristen, jeden Wachmann, jeden Hilfsprofessor, der Extraarbeit brauchte.

»Zugang über die Hinterlieferung?«, fragte Kaito.

»Einfacher«, sagte Brummel. »Als Student. Ich kenne jemanden in der Vergabekommission.«

Sechs Monate. Kaito verbrachte sie damit, Brummels Liefernetz kennenzulernen — und dabei, nebenbei, die Akademie physische Infrastruktur so gut zu kartographieren wie kein offiziell zugelassener Student je könnte. Lagerpläne. Wachdienst-Rhythmus. Drei Notausgänge, die auf keiner offiziellen Karte standen.

Als die Zulassung ankam, war sie echt.

Er kannte das Gebäude besser als sein Zimmer.`,
 choices: [{ text: "→ Aetheria Prime", next: "a3k1_aetheria" }],
 affinityEffect: { gorrick: 5 },
 },

 a3k0_weg_solo: {
 act: "AKT III", chapter: "Fünf Jahre — Kreuzweg", title: "Auf eigene Faust",
 scene: "Kreuzweg → Aetheria Prime — fünf Jahre später",
 bg: "void", music: "theme_void_terminal",
 text: `Kein Empfehlungsbrief.

Kein Netzwerk. Keine Kontakte. Keine Backstory, die jemand anderes gebaut hatte.

Nur Kaito und das Terminal und fünf Jahre Zeit.

Frau Voss: »Du bist entweder sehr mutig oder sehr dumm.«
Kaito: »Beides hilft.«
Frau Voss: »Fair.«

Sie lehrte ihn trotzdem alles, was sie konnte. Weil, sagte sie, jemand der auf eigene Faust handelt es doppelt gut können muss.

Fünf Jahre:
[Code.Spoof] auf Akademie-Niveau. Identitätswechsel in unter dreißig Sekunden. System-Architektur dreier Provinzen auswendig. Zwölf tote Briefkästen in sieben Städten. Eine vollständige Legende, aufgebaut aus Fragmenten, die keiner einzelnen überprüfbaren Quelle zugeordnet werden konnten.

Kein Empfehlungsbrief.

Stattdessen: ein Aufnahmetest, anonym absolviert, mit einer Punktzahl, die die Kommission drei Tage lang diskutieren ließ.

Er ließ sich einladen, weil er gut genug war, um eingeladen zu werden.
...
Sera zeigte Liebe, indem sie Tunnel durch Felsen schmolz.`,
 ...
 choices: [{ text: "→ Nacht 2: Aldwins Nachricht", next: "a3k7_aldwin_brief" }],
...
Meridia lieferte eine nüchterne Analyse: »Mordecai wird nicht aufhören. Du musst die Akademie verlassen. Aber du hast die Wahl, WIE.«`,
 ...
 next: "a3k9_abschiede",
 alignEffect: { schatten: 2, chaos: 3, verborgenheit: 2 },
 ...
 act: "AKT III", chapter: "Kapitel 18 — Die Verhandlung", title: "Mordecai",
 scene: "Akademie — Erzbischofs Arbeitszimmer, Nacht",
 bg: "city", music: "theme_void_terminal",
 text: `Das Arbeitszimmer war genau das, was Kaito erwartet hatte: Bücher, Kerzen, das Gewicht von einem Mann der seit dreißig Jahren Entscheidungen trifft, die andere Menschen nie sehen.

Mordecai saß hinter dem Schreibtisch. Er sah — überraschenderweise — nicht wie ein Feind aus.

Er sah wie jemand aus, der sehr müde ist.

»Du weißt, was du bist«, sagte Mordecai. Keine Frage.

»Ich weiß mehr als das«, sagte Kaito. »Ich weiß vom Update. Ich weiß, was es tut. Ich weiß, warum du es willst.«

Schweigen.

»Und ich weiß«, fuhr Kaito fort, »Dass du es aus einem Grund willst, der dir einmal richtig erschien.«

Mordecai schaute ihn an. Lange.

»Was willst du?«

»Nichts von dir.« Pause. »Ich gehe. Ich verschwinde. Kein Skandal. Keine öffentliche Konfrontation. Die Akademie verliert einen unbedeutenden Stipendiaten.«

»Und im Gegenzug?«

»Sie erinnern sich, dass Sie das Update überdenken können. Dass es noch Zeit gibt.«

Mordecai stand auf. Sehr langsam. Ging zum Fenster.

»Du bist zwölf Jahre alt«, sagte er.

»Ja.«

»Und du verhandelst mit mir wie ein Diplomat.«

»Ich bin aufmerksam aufgewachsen.«

Ein sehr langer Moment.

»Geh«, sagte Mordecai schließlich. »Jetzt. Bevor ich mir das anders überlege.«

Er schaute weiter aus dem Fenster.

»Und wenn du in zehn Jahren noch lebst«, sagte er, ohne sich umzudrehen, »Dann reden wir nochmal.«

Kaito verließ das Arbeitszimmer.

Hinter ihm: ein Erzbischof, der am Fenster stand und zum ersten Mal seit Jahren nicht wusste, was als nächstes kommt.

Das war Verhandlung. Kein Sieg. Nur: ein bisschen Raum.`,
 choices: [{ text: "→ Die Abschiede", next: "a3k9_abschiede" }],
...
Ein blendendes, weißes Licht — purer Aether — explodierte im Raum.
...
— Gregor«`,
 ...
 choices: [{ text: "→ AKT IV: Elevation — Die Nullen entstehen", next: "a4k1_teaser" }],
